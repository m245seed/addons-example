# Moltbot HA Add-on - Development Guidelines

## Repository Info
- **Original Fork:** https://github.com/ngutman/moltbot-ha-addon
- **This Repo:** https://github.com/Al3xand3r1987/moltbot-ha
- **Maintainer:** Alexander (Al3xand3r1987)
- **Status:** Production-ready fork with enhanced features

## Project Structure
- Add-on source: `moltbot_gateway/`
- Configuration: `moltbot_gateway/config.json`
- Startup script: `moltbot_gateway/run.sh`
- Documentation: Root-level guides (INSTALLATION.md, CONFIGURATION.md, etc.)
- Changelog: `moltbot_gateway/CHANGELOG.md`
